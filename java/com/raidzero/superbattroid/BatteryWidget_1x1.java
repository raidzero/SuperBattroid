 ...
 */
public class BatteryWidget_1x1 extends BatteryWidget {
    private static final String tag = "BatteryWidget_3x1";
    ...
    protected void updateViews(Context context) {
        ...
        ComponentName componentName = new ComponentName(context, BatteryWidget_1x1.class);
